...
function printLetterByLetter(destination, message, speed){
    ...
    var interval = setInterval(function(){
       document.getElementById("test").innerHTML  += message.charAt(i);
        i++;
        if (i > message.length){
...
printLetterByLetter("someElement", "Hello world, Happy to see you. Remember your childhood with a fast snake! ", 80);
...
// Ширина та висота з елемента canvas
...
// Висвітлюємо текст "Game Over" та очищуємо інтервал
...
//щоб переміщати її в поточному напрямку
...
// Обробник для маніпуляції напрямками, заданими натисканням клавіш
